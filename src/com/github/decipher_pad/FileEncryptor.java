...
public class FileEncryptor {
    ...
    public static void decryptFile(String fileName, String pass) throws GeneralSecurityException, IOException {
        ...
        // The new .encrypted extension will be removed from the new file
        FileOutputStream target = new FileOutputStream(new File(fileName.substring(0, fileName.lastIndexOf('.'))));
